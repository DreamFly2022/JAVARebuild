 ...
 * @Author lifei
 */
public class MySimpleKafkaOffsetAsyncConsumer {

    public static void main(String[] args) {
        MySimpleKafkaOffsetAsyncConsumer consumer = new MySimpleKafkaOffsetAsyncConsumer();
    ...
    public void consumerPoll() {
        ...
        // kafka group id 的配置
        props.setProperty("group.id", "group3");
        // 从头开始消费数据
        props.setProperty(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");

        // 同步提交： 1. 关闭自动提交； 2. 调用异步提交  consumer.commitAsync();
